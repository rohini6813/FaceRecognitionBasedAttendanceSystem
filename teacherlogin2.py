...
from teacher_reg2 import Teacherregistry2
...
class Login2:
    def __init__(self,root) -> None:
        ...
        teacher_log_button_1.place(relx=0.5, rely=0.45, anchor='center',width=220,height=220)
        ...
        teacher_log_button_2.place(relx=0.5, rely=0.57, anchor='center',width=220,height=40)
    ...
    def register(self):
        ...
        self.app = Teacherregistry2(self.new_window)
